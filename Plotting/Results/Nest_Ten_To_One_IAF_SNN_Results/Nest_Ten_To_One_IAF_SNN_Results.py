...
plotname = 'ten_to_one_neuron_nest_tinyspike'
...
with open('./ten_to_one_neuron_output.csv') as f:
...
plotValueOutputs('94380434038688', '0', '0', 'TinyNN Neuron')
...
# Plot difference
y = []
for nest, sim in zip([float(x[1]) for x in nestValueContent], [float(x[4]) for x in valueContent if '94380434038688' == x[1] and '0' == x[2] and '0' == x[3]][:-1]):
    y.append(nest - sim)
