...
fig = plt.figure()
fig.suptitle('Latency coding encode and decode of test signal 2', fontsize='large', fontweight='bold')
...
for index, dt, window in zip([0,1,2], ['0.001', '0.0001', '0.00001'], ['0.03', '0.003', '0.0003']):
    ...
    for arg in arguments:
        output = check_output(['../../../build/Test/Latency_Coding_Encode_Decode_Results', *arg, window, dt, '0', '0.1'])
...
if saveFigure:
    plt.savefig(os.path.dirname(os.path.abspath(__file__)) + '/../figures/' + 'latency_coding_plot_all_signal_2' + '.pdf', bbox_inches='tight', dpi=300, format='pdf')
