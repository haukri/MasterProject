...
if noiseOn:
    plotname = 'population_latency_coding_rmse_signal_2'
    std = '0.1'
else:
    plotname = 'population_latency_coding_rmse_signal_1'

# ------------- Plot Setup ------------- #
plt.rcParams['figure.figsize'] = (8,6)
plt.title('Test signal 2 \n RMSE for population latency encoding and decoding', fontsize='xx-large', fontweight='bold')
...
for dt, window in zip(['0.001', '0.0001', '0.00001'], ['0.03', '0.003', '0.0003']):
    ...
    for arg in arguments:
        output = check_output(['../../../build/Test/Receptive_Field_Coding_Encode_Decode_Results', *arg, window, '50', dt, '0', std])
